...
public:
	...
	bool SetCollision(int, ID3D11DeviceContext*);
	bool SetPointsCollected(int, ID3D11DeviceContext*);
...
private:
	...
	// for collision
	SentenceType *m_sentence12;
	SentenceType *m_sentence13, *m_sentence14;
};
